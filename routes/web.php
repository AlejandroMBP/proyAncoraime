...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/cargos/editar', [CargoController::class, 'editarCargo'])->name('administrador.cargos.editar');
    Route::post('/cargos/agregar', [CargoController::class, 'agregarCargo'])->name('administrador.cargos.agregar');
    Route::post('/cargos/editarEstado/{id}', [CargoController::class, 'editarEstadoCargo'])->name('administrador.cargos.editarEstado');
    ...
    Route::post('/funcionarios/editar', [FuncionarioController::class, 'editarFuncionario'])->name('administrador.funcionarios.editar');
    Route::post('/funcionarios/agregar', [FuncionarioController::class, 'agregarFuncionario'])->name('administrador.funcionarios.agregar');
    Route::post('/funcionarios/editarEstado/{id}', [FuncionarioController::class, 'editarEstadoFuncionario'])->name('administrador.funcionarios.editarEstado');
