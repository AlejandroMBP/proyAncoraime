<form id="formReportePrestamo" method="POST" action="{{ route('prestamos.reporte') }}" target="_blank">
    @csrf
    <div class="modal fade" id="reportePrestamoModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content custom-modal">
                ...
                <div class="modal-body custom-modal-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select id="tituloDocumento" name="tituloDocumento" class="form-select" required>
                                <option value="" disabled selected>Seleccione</option>
                                @foreach ($nombreDocumento as $doc)
                                    <option value="{{ $doc->id }}">
                                        {{ $doc->titulo }}
                                    </option>
                                @endforeach
                ...
                <div class="modal-footer custom-modal-footer">
                    ...
                    <button type="submit" class="custom-save-btn"
                        formaction="{{ route('prestamos.reporte') }} ">Generar
                        PDF</button>
                </div>
            </div>
        </div>
